...
// Transition overlays per category (decorative image during spin)
...
export default function TapOneGame() {
  ...
  useEffect(() => {
    ...
    idle(async () => {
      ...
      const firstCards = categories.map(c => `/images/cards/${c.elements[0]?.id}.png`).filter(Boolean);
        ...
        <div className="p-1 sm:p-1.5">
          ...
          >
            {phase === 'spinning' && !isLocked ? (
              /* Spinning animation with overlay */
              <div className="relative w-full h-full">
                <img
                  src={`/images/cards/${currentSpinCard}.png`}
                  alt="Loading"
                  className="w-full h-full object-contain p-0.5 sm:p-1 opacity-70"
                  loading="eager"
                />
                {/* Category overlay during spin */}
                {overlayUrl && (
      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        <div className="flex-1 flex items-center justify-center p-2 sm:p-3 md:p-4">
          <div className="w-full max-w-5xl">
            ...
            {/* Row 3: Last 2 categories + Best Rank */}
            ...
            {/* Best Rank Panel - Mobile (2-col below grid) */}
