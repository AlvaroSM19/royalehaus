...
// ÔöÇÔöÇÔöÇ Pair pools ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
                ...
                <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
                  <div className="relative w-full max-w-md rounded-2xl overflow-hidden shadow-2xl" style={{ background: 'linear-gradient(180deg, rgba(20,15,8,0.98) 0%, rgba(35,25,12,0.99) 50%, rgba(20,15,8,0.98) 100%)', border: '3px solid rgba(245,180,50,0.7)', boxShadow: '0 0 40px rgba(245,180,50,0.3)' }}>
                    ...
                    <div className="p-6 sm:p-8 text-center">
                      <div className="text-4xl mb-2">­ƒÅå</div>
                      ...
                      <p className="text-slate-300 mb-5 text-sm">
                        Completed in <span className="text-amber-400 font-bold">{formatTime(time)}</span> with <span className="text-cyan-400 font-bold">{moves} moves</span> ÔÇö Score: <span className="text-emerald-400 font-bold">{score}</span>
                      </p>
