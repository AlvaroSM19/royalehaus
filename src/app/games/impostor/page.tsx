...
import { baseCards as allBaseCards } from '@/data';
...
type GameMode = 'type' | 'rarity' | 'elixir' | 'releaseYear';
...
export default function ImpostorPage() {
  ...
  const generateRound = useCallback(() => {
    ...
    let allModes: GameMode[] = ['type', 'rarity', 'elixir', 'releaseYear'];
    ...
    const allPossibleModes: GameMode[] = ['type', 'rarity', 'elixir', 'releaseYear'];
